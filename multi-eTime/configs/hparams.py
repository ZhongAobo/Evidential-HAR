...
class HAR():
    def __init__(self):
        ...
        self.alg_hparams = {
            ...
            'NO_ADAPT': {'learning_rate': args.lr, 'src_cls_loss_wt': 1, 'alpha': 5.0},
            'TARGET_ONLY': {'learning_rate': args.lr, 'trg_cls_loss_wt': 1, 'alpha': 5.0},
            "SASA": {
            ...
            'CoTMix': {'learning_rate': args.lr, 'mix_ratio': 0.9, 'temporal_shift': 14,
                       'src_cls_weight': 0.78, 'src_supCon_weight': 0.1, 'trg_cont_weight': 0.1,
                       'trg_entropy_weight': 0.05, "alpha": 5.0},
            'MCD': {'learning_rate': args.lr, 'src_cls_loss_wt': 9.74, 'domain_loss_wt': 5.43, "alpha": 5.0},
...
class EEG():
    def __init__(self):
        ...
        self.alg_hparams = {
            'NO_ADAPT': {'learning_rate': args.lr, 'src_cls_loss_wt': 1},
            'TARGET_ONLY': {'learning_rate': args.lr, 'trg_cls_loss_wt': 1},
            "SASA": {
            ...
            'CoTMix': {'learning_rate': args.lr, 'mix_ratio': 0.79, 'temporal_shift': 300,
...
class WISDM():
    def __init__(self):
        ...
        self.alg_hparams = {
            ...
            'NO_ADAPT': {'learning_rate': args.lr, 'src_cls_loss_wt': 1.0, 'alpha': 5.0},
            'TARGET_ONLY': {'learning_rate': args.lr, 'trg_cls_loss_wt': 1, 'alpha': 5.0},
            "SASA": {
...
class HHAR():
    def __init__(self):
        ...
        self.alg_hparams = {
            ...
            'CoTMix': {'learning_rate': args.lr, 'mix_ratio': 0.52, 'temporal_shift': 14,
