...
parser.add_argument('--da_method',              default='DDC',               type=str, help='NO_ADAPT, DDC, Deep_Coral, MMDA, DANN, CDAN, DIRT, DSAN, HoMM, CoDATS, AdvSKM, SASA')

# ========= Select the DATASET ==============
parser.add_argument('--data_path',              default=r'/media/xxxy/Data1/ZXY/zxy/eTime/dataset',                  type=str, help='Path containing dataset')
...
parser.add_argument('--down',default='rand',type=str)
